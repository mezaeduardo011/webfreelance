...
<head>
    ...
    <title>VairoWork | Sitio web</title>
...
<div class="wrapper">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header">No tiene mensajes disponibles.</li>
                            <li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview" onclick="logout();">
                    <a href="#">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2016 .All rights reserved.
    </footer>
